...
$dados_semana1 = "select ALL_IL, MANU_IL, ALL_FA, MANU_FA from STORE_STATUS WHERE SEMANA_NUMERO = $semana1_query";
$dados_semana2 = "select ALL_IL, MANU_IL, ALL_FA, MANU_FA from STORE_STATUS WHERE SEMANA_NUMERO = $semana2_query";
$dados_semana3 = "select ALL_IL, MANU_IL, ALL_FA, MANU_FA from STORE_STATUS WHERE SEMANA_NUMERO = $semana3_query";
